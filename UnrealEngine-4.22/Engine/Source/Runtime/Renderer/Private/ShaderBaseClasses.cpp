	...
	FMeshDrawSingleShaderBindings& ShaderBindings) const
{
	...
	ShaderBindings.Add(GetUniformBufferParameter<FInstancedView2UniformShaderParameters>(), DrawRenderState.GetInstancedView2UniformBuffer()); // FB Bulgakov - Instanced Multi View Rendering
}
