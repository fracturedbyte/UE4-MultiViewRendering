	...
	: FMeshPassProcessor(Scene, Scene->GetFeatureLevel(), InViewIfDynamicMeshCommand, InDrawListContext)
{
	...
	PassDrawRenderState.SetInstancedView2UniformBuffer(Scene->UniformBuffers.InstancedCustomDepthView2UniformBuffer); // FB Bulgakov - Instanced Multi View Rendering
