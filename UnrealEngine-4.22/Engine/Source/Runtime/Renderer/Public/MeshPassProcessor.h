...
struct FMeshPassProcessorRenderState
{
	FMeshPassProcessorRenderState(const FSceneView& SceneView, FUniformBufferRHIParamRef InPassUniformBuffer = nullptr) : 
		...
		, InstancedView2UniformBuffer() // FB Bulgakov - Instanced Multi View Rendering
	...
	FORCEINLINE_DEBUGGABLE FMeshPassProcessorRenderState(const FMeshPassProcessorRenderState& DrawRenderState) :
		...
		, InstancedView2UniformBuffer(DrawRenderState.InstancedView2UniformBuffer) // FB Bulgakov - Instanced Multi View Rendering
...
public:
	...
	FORCEINLINE_DEBUGGABLE void SetInstancedView2UniformBuffer(const TUniformBufferRef<FInstancedView2UniformShaderParameters>& InViewUniformBuffer)
	{
		InstancedView2UniformBuffer = InViewUniformBuffer;
	}
	// FB Bulgakov End
	...
	// FB Bulgakov Begin - Instanced Multi View Rendering
	FORCEINLINE_DEBUGGABLE const TUniformBufferRef<FInstancedView2UniformShaderParameters>& GetInstancedView2UniformBuffer() const
	{
		return InstancedView2UniformBuffer.IsValid() ? InstancedView2UniformBuffer : reinterpret_cast<const TUniformBufferRef<FInstancedView2UniformShaderParameters>&>(ViewUniformBuffer);
	}
	// FB Bulgakov End
...
private:
	...
	TUniformBufferRef<FInstancedView2UniformShaderParameters> InstancedView2UniformBuffer; // FB Bulgakov - Instanced Multi View Rendering
