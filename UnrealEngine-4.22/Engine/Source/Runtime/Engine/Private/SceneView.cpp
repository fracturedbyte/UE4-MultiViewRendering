...
IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FInstancedView2UniformShaderParameters, "InstancedView2"); // FB Bulgakov - Instanced Multi View Rendering
	...
	const FViewMatrices& InPrevViewMatrices) const
{
	...
	ViewUniformShaderParameters.NumViews = Family ? Family->Views.Num() : 0; // FB Bulgakov - Instanced Multi View Rendering
